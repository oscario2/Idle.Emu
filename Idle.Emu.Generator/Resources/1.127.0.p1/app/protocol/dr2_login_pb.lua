...
PB_SERVER_LOGIN = protobuf.Descriptor()
PB_SERVER_LOGIN_SID_FIELD = protobuf.FieldDescriptor()
PB_SERVER_LOGIN_SNAME_FIELD = protobuf.FieldDescriptor()
PB_SERVER_LOGIN_PNAME_FIELD = protobuf.FieldDescriptor()
PB_SERVER_LOGIN_PLOGO_FIELD = protobuf.FieldDescriptor()
PB_SERVER_LOGIN_PLV_FIELD = protobuf.FieldDescriptor()
PB_SERVER_LOGIN_FLAG_FIELD = protobuf.FieldDescriptor()
PB_SERVER_LOGIN_UID_FIELD = protobuf.FieldDescriptor()
PB_SERVER_LOGIN_BORDER_FIELD = protobuf.FieldDescriptor()
...
PBREQ_REG_ENV_FIELD = protobuf.FieldDescriptor()
...
PBREQ_LOGIN_ENV_FIELD = protobuf.FieldDescriptor()
...
PBRSP_LOGIN_CREATETS_FIELD = protobuf.FieldDescriptor()
...
PBRSP_THIRDLOGIN_EXT_FIELD = protobuf.FieldDescriptor()
PBRSP_THIRDLOGIN_MID_FIELD = protobuf.FieldDescriptor()
PBREQ_SERVERS_LOGIN = protobuf.Descriptor()
PBREQ_SERVERS_LOGIN_UID_FIELD = protobuf.FieldDescriptor()
PBRSP_SERVERS_LOGIN = protobuf.Descriptor()
PBRSP_SERVERS_LOGIN_SERVERS_FIELD = protobuf.FieldDescriptor()
PBRSP_SERVERS_LOGIN_RECENT_SID_FIELD = protobuf.FieldDescriptor()
...
PB_SERVER.fields = {
  PB_SERVER_ID_FIELD,
  PB_SERVER_IP_FIELD,
  PB_SERVER_PORT_FIELD,
  PB_SERVER_NAME_FIELD,
  PB_SERVER_STATUS_FIELD,
  PB_SERVER_LANGUAGE_FIELD,
  PB_SERVER_NICKNAME_FIELD
}
PB_SERVER.is_extendable = false
PB_SERVER.extensions = {}
PB_SERVER_LOGIN_SID_FIELD.name = "sid"
PB_SERVER_LOGIN_SID_FIELD.full_name = ".pb_server_login.sid"
PB_SERVER_LOGIN_SID_FIELD.number = 1
PB_SERVER_LOGIN_SID_FIELD.index = 0
PB_SERVER_LOGIN_SID_FIELD.label = 2
PB_SERVER_LOGIN_SID_FIELD.has_default_value = false
PB_SERVER_LOGIN_SID_FIELD.default_value = 0
PB_SERVER_LOGIN_SID_FIELD.type = 5
PB_SERVER_LOGIN_SID_FIELD.cpp_type = 1
PB_SERVER_LOGIN_SNAME_FIELD.name = "sname"
PB_SERVER_LOGIN_SNAME_FIELD.full_name = ".pb_server_login.sname"
PB_SERVER_LOGIN_SNAME_FIELD.number = 2
PB_SERVER_LOGIN_SNAME_FIELD.index = 1
PB_SERVER_LOGIN_SNAME_FIELD.label = 2
PB_SERVER_LOGIN_SNAME_FIELD.has_default_value = false
PB_SERVER_LOGIN_SNAME_FIELD.default_value = ""
PB_SERVER_LOGIN_SNAME_FIELD.type = 9
PB_SERVER_LOGIN_SNAME_FIELD.cpp_type = 9
PB_SERVER_LOGIN_PNAME_FIELD.name = "pname"
PB_SERVER_LOGIN_PNAME_FIELD.full_name = ".pb_server_login.pname"
PB_SERVER_LOGIN_PNAME_FIELD.number = 3
PB_SERVER_LOGIN_PNAME_FIELD.index = 2
PB_SERVER_LOGIN_PNAME_FIELD.label = 1
PB_SERVER_LOGIN_PNAME_FIELD.has_default_value = false
PB_SERVER_LOGIN_PNAME_FIELD.default_value = ""
PB_SERVER_LOGIN_PNAME_FIELD.type = 9
PB_SERVER_LOGIN_PNAME_FIELD.cpp_type = 9
PB_SERVER_LOGIN_PLOGO_FIELD.name = "plogo"
PB_SERVER_LOGIN_PLOGO_FIELD.full_name = ".pb_server_login.plogo"
PB_SERVER_LOGIN_PLOGO_FIELD.number = 4
PB_SERVER_LOGIN_PLOGO_FIELD.index = 3
PB_SERVER_LOGIN_PLOGO_FIELD.label = 1
PB_SERVER_LOGIN_PLOGO_FIELD.has_default_value = false
PB_SERVER_LOGIN_PLOGO_FIELD.default_value = 0
PB_SERVER_LOGIN_PLOGO_FIELD.type = 5
PB_SERVER_LOGIN_PLOGO_FIELD.cpp_type = 1
PB_SERVER_LOGIN_PLV_FIELD.name = "plv"
PB_SERVER_LOGIN_PLV_FIELD.full_name = ".pb_server_login.plv"
PB_SERVER_LOGIN_PLV_FIELD.number = 5
PB_SERVER_LOGIN_PLV_FIELD.index = 4
PB_SERVER_LOGIN_PLV_FIELD.label = 1
PB_SERVER_LOGIN_PLV_FIELD.has_default_value = false
PB_SERVER_LOGIN_PLV_FIELD.default_value = 0
PB_SERVER_LOGIN_PLV_FIELD.type = 5
PB_SERVER_LOGIN_PLV_FIELD.cpp_type = 1
PB_SERVER_LOGIN_FLAG_FIELD.name = "flag"
PB_SERVER_LOGIN_FLAG_FIELD.full_name = ".pb_server_login.flag"
PB_SERVER_LOGIN_FLAG_FIELD.number = 6
PB_SERVER_LOGIN_FLAG_FIELD.index = 5
PB_SERVER_LOGIN_FLAG_FIELD.label = 1
PB_SERVER_LOGIN_FLAG_FIELD.has_default_value = false
PB_SERVER_LOGIN_FLAG_FIELD.default_value = 0
PB_SERVER_LOGIN_FLAG_FIELD.type = 5
PB_SERVER_LOGIN_FLAG_FIELD.cpp_type = 1
PB_SERVER_LOGIN_UID_FIELD.name = "uid"
PB_SERVER_LOGIN_UID_FIELD.full_name = ".pb_server_login.uid"
PB_SERVER_LOGIN_UID_FIELD.number = 7
PB_SERVER_LOGIN_UID_FIELD.index = 6
PB_SERVER_LOGIN_UID_FIELD.label = 1
PB_SERVER_LOGIN_UID_FIELD.has_default_value = false
PB_SERVER_LOGIN_UID_FIELD.default_value = 0
PB_SERVER_LOGIN_UID_FIELD.type = 5
PB_SERVER_LOGIN_UID_FIELD.cpp_type = 1
PB_SERVER_LOGIN_BORDER_FIELD.name = "border"
PB_SERVER_LOGIN_BORDER_FIELD.full_name = ".pb_server_login.border"
PB_SERVER_LOGIN_BORDER_FIELD.number = 8
PB_SERVER_LOGIN_BORDER_FIELD.index = 7
PB_SERVER_LOGIN_BORDER_FIELD.label = 1
PB_SERVER_LOGIN_BORDER_FIELD.has_default_value = false
PB_SERVER_LOGIN_BORDER_FIELD.default_value = 0
PB_SERVER_LOGIN_BORDER_FIELD.type = 5
PB_SERVER_LOGIN_BORDER_FIELD.cpp_type = 1
PB_SERVER_LOGIN.name = "pb_server_login"
PB_SERVER_LOGIN.full_name = ".pb_server_login"
PB_SERVER_LOGIN.nested_types = {}
PB_SERVER_LOGIN.enum_types = {}
PB_SERVER_LOGIN.fields = {
  PB_SERVER_LOGIN_SID_FIELD,
  PB_SERVER_LOGIN_SNAME_FIELD,
  PB_SERVER_LOGIN_PNAME_FIELD,
  PB_SERVER_LOGIN_PLOGO_FIELD,
  PB_SERVER_LOGIN_PLV_FIELD,
  PB_SERVER_LOGIN_FLAG_FIELD,
  PB_SERVER_LOGIN_UID_FIELD,
  PB_SERVER_LOGIN_BORDER_FIELD
}
PB_SERVER_LOGIN.is_extendable = false
PB_SERVER_LOGIN.extensions = {}
...
PBRSP_PUB.fields = {
  PBRSP_PUB_STATUS_FIELD,
  PBRSP_PUB_LANGUAGE_FIELD,
  PBRSP_PUB_VSN_FIELD,
  PBRSP_PUB_PUB_FIELD
}
...
PBREQ_REG_ENV_FIELD.name = "env"
PBREQ_REG_ENV_FIELD.full_name = ".pbreq_reg.env"
PBREQ_REG_ENV_FIELD.number = 4
PBREQ_REG_ENV_FIELD.index = 3
PBREQ_REG_ENV_FIELD.label = 1
PBREQ_REG_ENV_FIELD.has_default_value = false
PBREQ_REG_ENV_FIELD.default_value = ""
PBREQ_REG_ENV_FIELD.type = 9
PBREQ_REG_ENV_FIELD.cpp_type = 9
PBREQ_REG.name = "pbreq_reg"
PBREQ_REG.full_name = ".pbreq_reg"
PBREQ_REG.nested_types = {}
PBREQ_REG.enum_types = {}
PBREQ_REG.fields = {
  PBREQ_REG_RDID_FIELD,
  PBREQ_REG_APPVERSION_FIELD,
  PBREQ_REG_OSVERSION_FIELD,
  PBREQ_REG_ENV_FIELD
}
...
PBRSP_REG.fields = {
  PBRSP_REG_STATUS_FIELD,
  PBRSP_REG_UID_FIELD,
  PBRSP_REG_ACCOUNT_FIELD,
  PBRSP_REG_PASSWORD_FIELD
}
...
PBRSP_SALT.fields = {
  PBRSP_SALT_STATUS_FIELD,
  PBRSP_SALT_SALT_FIELD,
  PBRSP_SALT_UID_FIELD
}
...
PBREQ_LOGIN_ENV_FIELD.name = "env"
PBREQ_LOGIN_ENV_FIELD.full_name = ".pbreq_login.env"
PBREQ_LOGIN_ENV_FIELD.number = 5
PBREQ_LOGIN_ENV_FIELD.index = 4
PBREQ_LOGIN_ENV_FIELD.label = 1
PBREQ_LOGIN_ENV_FIELD.has_default_value = false
PBREQ_LOGIN_ENV_FIELD.default_value = ""
PBREQ_LOGIN_ENV_FIELD.type = 9
PBREQ_LOGIN_ENV_FIELD.cpp_type = 9
PBREQ_LOGIN.name = "pbreq_login"
PBREQ_LOGIN.full_name = ".pbreq_login"
PBREQ_LOGIN.nested_types = {}
PBREQ_LOGIN.enum_types = {}
PBREQ_LOGIN.fields = {
  PBREQ_LOGIN_CHECKSUM_FIELD,
  PBREQ_LOGIN_IDFA_FIELD,
  PBREQ_LOGIN_KEYCHAIN_FIELD,
  PBREQ_LOGIN_IDFV_FIELD,
  PBREQ_LOGIN_ENV_FIELD
}
...
PBRSP_LOGIN_CREATETS_FIELD.name = "createTs"
PBRSP_LOGIN_CREATETS_FIELD.full_name = ".pbrsp_login.createTs"
PBRSP_LOGIN_CREATETS_FIELD.number = 6
PBRSP_LOGIN_CREATETS_FIELD.index = 5
PBRSP_LOGIN_CREATETS_FIELD.label = 1
PBRSP_LOGIN_CREATETS_FIELD.has_default_value = false
PBRSP_LOGIN_CREATETS_FIELD.default_value = ""
PBRSP_LOGIN_CREATETS_FIELD.type = 9
PBRSP_LOGIN_CREATETS_FIELD.cpp_type = 9
PBRSP_LOGIN.name = "pbrsp_login"
PBRSP_LOGIN.full_name = ".pbrsp_login"
PBRSP_LOGIN.nested_types = {}
PBRSP_LOGIN.enum_types = {}
PBRSP_LOGIN.fields = {
  PBRSP_LOGIN_STATUS_FIELD,
  PBRSP_LOGIN_SESSION_FIELD,
  PBRSP_LOGIN_SID_FIELD,
  PBRSP_LOGIN_IS_FORMAL_FIELD,
  PBRSP_LOGIN_UID_FIELD,
  PBRSP_LOGIN_CREATETS_FIELD
}
...
PBRSP_THIRDLOGIN_EXT_FIELD.name = "ext"
PBRSP_THIRDLOGIN_EXT_FIELD.full_name = ".pbrsp_thirdlogin.ext"
PBRSP_THIRDLOGIN_EXT_FIELD.number = 6
PBRSP_THIRDLOGIN_EXT_FIELD.index = 5
PBRSP_THIRDLOGIN_EXT_FIELD.label = 1
PBRSP_THIRDLOGIN_EXT_FIELD.has_default_value = false
PBRSP_THIRDLOGIN_EXT_FIELD.default_value = ""
PBRSP_THIRDLOGIN_EXT_FIELD.type = 9
PBRSP_THIRDLOGIN_EXT_FIELD.cpp_type = 9
PBRSP_THIRDLOGIN_MID_FIELD.name = "mid"
PBRSP_THIRDLOGIN_MID_FIELD.full_name = ".pbrsp_thirdlogin.mid"
PBRSP_THIRDLOGIN_MID_FIELD.number = 7
PBRSP_THIRDLOGIN_MID_FIELD.index = 6
PBRSP_THIRDLOGIN_MID_FIELD.label = 1
PBRSP_THIRDLOGIN_MID_FIELD.has_default_value = false
PBRSP_THIRDLOGIN_MID_FIELD.default_value = 0
PBRSP_THIRDLOGIN_MID_FIELD.type = 5
PBRSP_THIRDLOGIN_MID_FIELD.cpp_type = 1
...
PBRSP_THIRDLOGIN.fields = {
  PBRSP_THIRDLOGIN_STATUS_FIELD,
  PBRSP_THIRDLOGIN_SESSION_FIELD,
  PBRSP_THIRDLOGIN_SID_FIELD,
  PBRSP_THIRDLOGIN_UID_FIELD,
  PBRSP_THIRDLOGIN_CREATETS_FIELD,
  PBRSP_THIRDLOGIN_EXT_FIELD,
  PBRSP_THIRDLOGIN_MID_FIELD
}
PBRSP_THIRDLOGIN.is_extendable = false
PBRSP_THIRDLOGIN.extensions = {}
PBREQ_SERVERS_LOGIN_UID_FIELD.name = "uid"
PBREQ_SERVERS_LOGIN_UID_FIELD.full_name = ".pbreq_servers_login.uid"
PBREQ_SERVERS_LOGIN_UID_FIELD.number = 1
PBREQ_SERVERS_LOGIN_UID_FIELD.index = 0
PBREQ_SERVERS_LOGIN_UID_FIELD.label = 1
PBREQ_SERVERS_LOGIN_UID_FIELD.has_default_value = false
PBREQ_SERVERS_LOGIN_UID_FIELD.default_value = 0
PBREQ_SERVERS_LOGIN_UID_FIELD.type = 5
PBREQ_SERVERS_LOGIN_UID_FIELD.cpp_type = 1
PBREQ_SERVERS_LOGIN.name = "pbreq_servers_login"
PBREQ_SERVERS_LOGIN.full_name = ".pbreq_servers_login"
PBREQ_SERVERS_LOGIN.nested_types = {}
PBREQ_SERVERS_LOGIN.enum_types = {}
PBREQ_SERVERS_LOGIN.fields = {PBREQ_SERVERS_LOGIN_UID_FIELD}
PBREQ_SERVERS_LOGIN.is_extendable = false
PBREQ_SERVERS_LOGIN.extensions = {}
PBRSP_SERVERS_LOGIN_SERVERS_FIELD.name = "servers"
PBRSP_SERVERS_LOGIN_SERVERS_FIELD.full_name = ".pbrsp_servers_login.servers"
PBRSP_SERVERS_LOGIN_SERVERS_FIELD.number = 1
PBRSP_SERVERS_LOGIN_SERVERS_FIELD.index = 0
PBRSP_SERVERS_LOGIN_SERVERS_FIELD.label = 3
PBRSP_SERVERS_LOGIN_SERVERS_FIELD.has_default_value = false
PBRSP_SERVERS_LOGIN_SERVERS_FIELD.default_value = {}
PBRSP_SERVERS_LOGIN_SERVERS_FIELD.message_type = PB_SERVER_LOGIN
PBRSP_SERVERS_LOGIN_SERVERS_FIELD.type = 11
PBRSP_SERVERS_LOGIN_SERVERS_FIELD.cpp_type = 10
PBRSP_SERVERS_LOGIN_RECENT_SID_FIELD.name = "recent_sid"
PBRSP_SERVERS_LOGIN_RECENT_SID_FIELD.full_name = ".pbrsp_servers_login.recent_sid"
PBRSP_SERVERS_LOGIN_RECENT_SID_FIELD.number = 2
PBRSP_SERVERS_LOGIN_RECENT_SID_FIELD.index = 1
PBRSP_SERVERS_LOGIN_RECENT_SID_FIELD.label = 1
PBRSP_SERVERS_LOGIN_RECENT_SID_FIELD.has_default_value = false
PBRSP_SERVERS_LOGIN_RECENT_SID_FIELD.default_value = 0
PBRSP_SERVERS_LOGIN_RECENT_SID_FIELD.type = 5
PBRSP_SERVERS_LOGIN_RECENT_SID_FIELD.cpp_type = 1
PBRSP_SERVERS_LOGIN.name = "pbrsp_servers_login"
PBRSP_SERVERS_LOGIN.full_name = ".pbrsp_servers_login"
PBRSP_SERVERS_LOGIN.nested_types = {}
PBRSP_SERVERS_LOGIN.enum_types = {}
PBRSP_SERVERS_LOGIN.fields = {PBRSP_SERVERS_LOGIN_SERVERS_FIELD, PBRSP_SERVERS_LOGIN_RECENT_SID_FIELD}
PBRSP_SERVERS_LOGIN.is_extendable = false
PBRSP_SERVERS_LOGIN.extensions = {}
pb_server = protobuf.Message(PB_SERVER)
pb_server_login = protobuf.Message(PB_SERVER_LOGIN)
...
pbreq_servers_login = protobuf.Message(PBREQ_SERVERS_LOGIN)
...
pbrsp_servers_login = protobuf.Message(PBRSP_SERVERS_LOGIN)
